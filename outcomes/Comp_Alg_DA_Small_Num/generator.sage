...
class Generator(BaseGenerator):
    def data(self):
        ...
        # Restrict k to small integers to keep the coefficient squares tiny
        k = random.choice([1, 2, 3])
        # Restrict c to small positive integers to keep reference triangle arithmetic easy by hand
        allowed_c = [2, 3, 4, 5, 6, 7]
